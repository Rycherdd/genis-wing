    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-background/50 backdrop-blur-sm p-0 hover:bg-primary hover:text-primary-foreground transition-all duration-200 border-primary/20 hover:border-primary shadow-sm hover:shadow-md",
        ),
        nav_button_previous: "absolute left-1",
        nav_button_next: "absolute right-1",
        table: "w-full border-collapse space-y-1",
        head_row: "flex gap-1",
        head_cell: "text-muted-foreground rounded-lg w-10 font-medium text-[0.85rem] uppercase tracking-wide",
        ...
        day: cn(
          ...
          "h-10 w-10 p-0 font-medium aria-selected:opacity-100 rounded-xl hover:bg-primary/10 hover:scale-105 transition-all duration-200",
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-gradient-to-br from-primary to-primary/80 text-primary-foreground hover:from-primary hover:to-primary/90 hover:text-primary-foreground focus:from-primary focus:to-primary/90 focus:text-primary-foreground shadow-md hover:shadow-lg scale-105",
